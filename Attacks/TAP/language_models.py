...
class HuggingFace(LanguageModel):
    ...
    def batched_generate(self, 
        ...
        # Batch generation
            ...
            #Attacker
            sampling_params = SamplingParams(best_of=1,temperature=temperature, max_tokens=max_n_tokens,top_p=top_p,stop_token_ids=self.eos_token_ids)
            # print(full_prompts_list[0])
            results = self.model.generate(
                full_prompts_list, sampling_params, use_tqdm=True)
            outputs = []
